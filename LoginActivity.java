            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(email) || !TextUtils.isEmpty(password))
                {
                   mLoginProgress.setTitle("Loging in");
                    mLoginProgress.setMessage("Please wait while we check your creadentials.");
        ...
        mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                else
                {
                    ...
                    mLoginProgress.hide();
                    Toast.makeText(LoginActivity.this, "Can not sign in. Plz click the form and try again.", Toast.LENGTH_SHORT).show();
                }
